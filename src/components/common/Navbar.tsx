...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            <span className=" absolute -top-1 bg-rabbit-red text-white text-xs rounded-full px-2 py-o.5">
              4
            </span>
          </button>
          {/* search */}
      ...
      {/* Mobile Navigation */}
      <div
        className={`fixed top-0 left-0 w-50 sm:w-1/3 md:hidden h-full bg-white shadow-lg transform transition-transform duration-300  z-50 ${
